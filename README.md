...
Scuola di Specializzazione in Fisica Medica - Anno accademico 2022/2023 (anno solare 2023/2024)
...
Per creare i database utilizzati nelle esercitazioni, scaricare da questo repository GitHub il file `slides_2024.sql` presente nella cartella `SQL_scripts` (clic con il pulsante destro del mouse sul pulsante `Raw`).
Poi, dalla propria area di lavoro (`SQL Workshop`), selezionare `Script SQL`. 
Caricare ed eseguire lo script `slides_2024.sql` (ignorare le segnalazioni di errore "table or view does not exist").

Ripetere queste operazioni utilizzando il file `journal_articles_2024.sql` presente nella cartella `SQL_scripts`
